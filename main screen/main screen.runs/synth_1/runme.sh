...
HD_PWD='C:/Users/Amn Naqvi/Desktop/main screen/main screen.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log start_screen.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source start_screen.tcl
