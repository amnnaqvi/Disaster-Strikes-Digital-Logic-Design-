...
HD_PWD='C:/Users/Amn Naqvi/Desktop/main screen/main screen.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log start_screen.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source start_screen.tcl -notrace
