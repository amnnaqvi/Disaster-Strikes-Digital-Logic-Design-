...
HD_PWD='C:/Users/Amn Naqvi/Desktop/keyboard_project/keyboard_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log keyboard_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source keyboard_1.tcl
