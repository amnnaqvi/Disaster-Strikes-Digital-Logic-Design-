...
HD_PWD='C:/Users/Amn Naqvi/Desktop/keyboard_project/keyboard_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log keyboard_1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source keyboard_1.tcl -notrace
